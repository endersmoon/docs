...
Each component goes through a lifecycle process before it is ready for production. This process is designed to ensure that the component is of high quality and is ready for use in production.


 <Callout>You can track our components on this <a className='underline' href="https://infoedge.atlassian.net/jira/core/projects/JHDS/list">Jira Board</a> </Callout>
...
- Has a clear purpose and rationale for why it belongs in Phoenix
- Uses Phoenix [tokens](/token/intro) with no references to any hard-coded static values
...
- Usage is being evaluated, and may not progress to beta. Evaluation includes any necessary research and data that supports why the component belongs in Phoenix.
- Components could be changed completely, or removed from the system
- Feedback is highly recommended and encouraged, [Create an issue](https://github.com/Shopify/Phoenix/issues/new)
...
- Used multiple times in production 
...
- Figma components available in the Phoenix Components file
...
- Usability testing and feedback has been gathered on UX and Tech
