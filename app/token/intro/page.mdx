...
|----------|-------------|-------------------|
| [Colors](/tokens/colors) | Brand colors, semantic colors, UI element colors | Text, backgrounds, borders, status indicators |
| [Typography](/tokens/typography) | Font families, sizes, weights, line heights | Headings, body text, captions, code blocks |
| [Spacing](/tokens/space) | Margins, paddings, gaps | Component spacing, layout grids, component composition |
